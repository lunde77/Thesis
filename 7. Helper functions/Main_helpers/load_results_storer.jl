function load_results_storer()
    ...
    global missing_capacity_storer = zeros(Days,4)                                                          # % of all time minutes where capacity were not availeble
    ...
    global total_cap_missed = zeros(4)                                                                       # how often were we overbidbing
