# -*- coding: utf-8 -*-
"""
Created on Wed Jan 24 11:10:04 2024
...
line1_y_values = np.mean(data_1400, axis=1)
...
plt.plot(x_values, line1_y_values[0:1440], color='limegreen', label='Mean', linewidth=4.7)
