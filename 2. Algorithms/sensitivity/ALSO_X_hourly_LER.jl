function ALSO_X_hourly_LER(total_flex_up_s, total_flex_do_s, res_20_s)
    ...
    Threads.@threads for t=1:24
        ...
        Mo, Con, Y_v, C_do_v, C_up_v = Stochastic_chancer_model_hourly_LER(total_flex_do_s[t,:,:], total_flex_up_s[t,:,:], res_20_s[t,:,:], q)
